...
import com.ml.e_bookreader.reader.animation.CoverPageAnim;
import com.ml.e_bookreader.reader.animation.HorizonPageAnim;
import com.ml.e_bookreader.reader.animation.NonePageAnim;
import com.ml.e_bookreader.reader.animation.PageAnimation;
import com.ml.e_bookreader.reader.animation.ScrollPageAnim;
import com.ml.e_bookreader.reader.animation.SimulationPageAnim;
import com.ml.e_bookreader.reader.animation.SlidePageAnim;
...
public class PageView extends View {
    ...
    public PageLoader getPageLoader(BookBean collBook) {
        ...
        // 根据书籍类型，获取具体的加载器
        if (collBook.getFileType().equals("txt")) {
            mPageLoader = new LocalPageLoader(this, collBook);
        } else {
            mPageLoader = new EpubPageLoader(this, collBook);
        }
